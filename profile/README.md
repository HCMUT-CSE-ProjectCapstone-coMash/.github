...
- Backend:
  - Ngôn ngữ: C#
  - Framework chính: ASP.NET Core 
  - Framework hỗ trợ: Entity Framework Core (ORM)
  - API: RESTful API
- Database:
  - Database chính: PostgreSQL
  - Database cho việc lưu trữ hình ảnh: Azure Blob Storage
- Mô hình xử lý hình ảnh:
  - Ngôn ngữ lập trình: Python
  - Thư viện TensorFlow cùng với Keras
  - API: FastAPI
